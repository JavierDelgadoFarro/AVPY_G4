...
Public Class View_Ventas
    ...
    Private Sub Venta_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        panel.Location = New System.Drawing.Point(100, 85)
        panel.Name = "Panel1"
        panel.Size = New System.Drawing.Size(140, 80)
...
#End Region
    ...
    Private Sub All_filter_click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        View_Detalle_Producto.Label2.Text = listaProductos.Item(0).stock
        View_Detalle_Producto.Label3.Text = listaProductos.Item(0).precio
        If File.Exists(picture.ImageLocation) Then
            View_Detalle_Producto.PictureBox1.Load(picture.ImageLocation) 'copiamos la imagen de un picturebox a otro'
        End If
        View_Detalle_Producto.PictureBox1.Name = picture.Name
        View_Detalle_Producto.Label6.Text = picture.Text
    ...
    Private Sub btn_cobrar_Click(sender As Object, e As EventArgs) Handles btn_cobrar.Click
        ...
        Dim obj2 As New Usuario_Negocio
